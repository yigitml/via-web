...
export class VideoGenerator {
  ...
  constructor() {
    ...
    console.info('VideoGenerator initialized');
  }
  ...
  private async generateVoiceovers(script: { text: string, voice: string, languageCode?: string }, outputPath: string) {
    try {
      console.info('Starting voiceover generation', { outputPath });
      ...
      if (!script.voice) {
        ...
        throw new Error('Voice ID is required for generating voiceover');
      }
      ...
      console.info('Voiceover generation completed successfully');
    } catch (error: any) {
      console.error('Error generating voiceover', { 
        error: error.message,
        stack: error.stack,
        originalError: error
      });
  ...
  async generateVideo({ 
    ...
    console.info('Starting video generation', { id, templateId });
    ...
    try {
      ...
      console.info('Video generation completed', { id });
      return id;
    } catch (error: any) {
